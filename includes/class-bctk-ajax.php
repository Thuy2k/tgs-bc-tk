...
class TGS_BCTK_Ajax
{
    ...
    private static function don_gia_lam_tron($tien_goc, $qty, $thanh_tien)
    {
        ...
        // Báo cáo: đơn giá là số nguyên — nhân với SL phải ra đúng con số trên
        // giấy, không để người đọc thấy 87.962,963.
    ...
    public static function build_sales_rows($blog_id, array $zones, $from, $to, $loai)
    {
        ...
        foreach ($raw as $r) {
             ...
             * là tưởng lệch quỹ, trong khi thực thu đúng 430.000 — và kế toán
             * đọc báo cáo doanh số cũng không nhận cột tiền có thập phân.
             *
