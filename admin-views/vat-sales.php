...
<script>
    ...
    jQuery(function ($) {
        ...
        function showDetailModal(row) {
            ...
            $.post('<?php echo admin_url("admin-ajax.php"); ?>', {
                ...
                if (res.success && res.data) {
                    ...
                    window.currentLedgerId = row.local_ledger_id;
        ...
        $(document).off('click', '#bctkDetailPdfBtn').on('click', '#bctkDetailPdfBtn', function() {
            ...
            // Debug log
            console.log('PDF button clicked - currentLedgerId:', window.currentLedgerId);
            console.log('PDF button clicked - currentBlogId:', window.currentBlogId);
            console.log('PDF button clicked - currentLedgerData:', window.currentLedgerData);
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    action: 'tgs_bctk_preview_sales_pdf',
                    nonce: '<?php echo wp_create_nonce(TGS_BCTK_Ajax::NONCE); ?>',
                ...
                success: function(res) {
                    ...
                    if (res.success && res.data && res.data.file_bytes_base64) {
                        ...
                        var fileName = res.data.file_name || 'invoice.pdf';
...
<!-- Modal xem PDF hóa đơn bán hàng -->
<div class="modal fade" id="bctkPdfModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Xem PDF hóa đơn</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Đóng"></button>
            </div>
